...
internal static partial class X11KeyTransform
{

    private static readonly Dictionary<X11Key, Key> s_keyFromVirtualKey = new Dictionary<X11Key, Key>
    {
    ...
    private static readonly Dictionary<Key, X11Key> s_virtualKeyFromKey = new Dictionary<Key, X11Key>
    {
        {Key.Cancel, X11Key.Cancel},
        {Key.Back, X11Key.BackSpace},
        {Key.Tab, X11Key.Tab},
        {Key.LineFeed, X11Key.Linefeed},
        {Key.Clear, X11Key.Clear},
        {Key.Return, X11Key.Return},
        {Key.Pause, X11Key.Pause},
        {Key.CapsLock, X11Key.Caps_Lock},
        {Key.Escape, X11Key.Escape},
        {Key.Space, X11Key.space},
        {Key.Prior, X11Key.Prior},
        {Key.PageDown, X11Key.Page_Down},
        {Key.End, X11Key.End},
        {Key.Home, X11Key.Home},
        {Key.Left, X11Key.Left},
        {Key.Up, X11Key.Up},
        {Key.Right, X11Key.Right},
        {Key.Down, X11Key.Down},
        {Key.Select, X11Key.Select},
        {Key.Print, X11Key.Print},
        {Key.Execute, X11Key.Execute},
        {Key.Insert, X11Key.Insert},
        {Key.Delete, X11Key.Delete},
        {Key.Help, X11Key.Help},
        {Key.A, X11Key.A},
        {Key.B, X11Key.B},
        {Key.C, X11Key.C},
        {Key.D, X11Key.D},
        ...
        {Key.Y, X11Key.Y},
        {Key.Z, X11Key.Z},
        {Key.LWin, X11Key.Super_L },
        {Key.RWin, X11Key.Super_R },
        {Key.Apps, X11Key.Menu},
        {Key.NumPad0, X11Key.KP_0},
        {Key.NumPad1, X11Key.KP_1},
        {Key.NumPad2, X11Key.KP_2},
        {Key.NumPad3, X11Key.KP_3},
        {Key.NumPad4, X11Key.KP_4},
        {Key.NumPad5, X11Key.KP_5},
        {Key.NumPad6, X11Key.KP_6},
        {Key.NumPad7, X11Key.KP_7},
        {Key.NumPad8, X11Key.KP_8},
        {Key.NumPad9, X11Key.KP_9},
        {Key.Multiply, X11Key.multiply},
        {Key.Add, X11Key.KP_Add},
        {Key.Subtract, X11Key.KP_Subtract},
        {Key.Decimal, X11Key.KP_Decimal},
        {Key.Divide, X11Key.KP_Divide},
        {Key.F1, X11Key.F1},
        {Key.F2, X11Key.F2},
        {Key.F3, X11Key.F3},
        {Key.F4, X11Key.F4},
        ...
        {Key.F23, X11Key.F23},
        {Key.F24, X11Key.R4},
        {Key.NumLock, X11Key.Num_Lock},
        {Key.Scroll, X11Key.Scroll_Lock},
        {Key.LeftShift, X11Key.Shift_L},
        {Key.RightShift, X11Key.Shift_R},
        {Key.LeftCtrl, X11Key.Control_L},
        {Key.RightCtrl, X11Key.Control_R},
        {Key.LeftAlt, X11Key.Alt_L},
        {Key.RightAlt, X11Key.Alt_R},
        {Key.OemMinus, X11Key.minus},
        {Key.OemPlus, X11Key.plus},
        {Key.OemOpenBrackets, X11Key.bracketleft},
        {Key.OemCloseBrackets, X11Key.bracketright},
        {Key.OemPipe, X11Key.bar},
        {Key.OemSemicolon, X11Key.semicolon},
        {Key.OemQuotes, X11Key.quotedbl},
        {Key.OemComma, X11Key.comma},
        {Key.OemPeriod, X11Key.period},
        {Key.Oem2, X11Key.slash},
        {Key.OemTilde, X11Key.asciitilde},
        {Key.D1, X11Key.XK_1},
        {Key.D2, X11Key.XK_2},
        {Key.D3, X11Key.XK_3},
        {Key.D4, X11Key.XK_4},
    ...
    {
        s_keyFromVirtualKey.TryGetValue((X11Key)virtualKey, out var result);
